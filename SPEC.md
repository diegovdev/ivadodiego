...
|---|---|---|---|---|---|---|
| T1 | x | scaffold | Commit hygiene: `.pre-commit-config.yaml` (commitizen + ruff), `pyproject.toml` `[tool.semantic_release]` config | V25,V26 | [#1](https://github.com/diegovdev/ivadodiego/issues/1) | feature/commit-hygiene-config-1 |
